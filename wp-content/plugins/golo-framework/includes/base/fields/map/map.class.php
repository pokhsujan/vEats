...
if ( !class_exists('GLF_Field_Map') ) {
	class GLF_Field_Map extends GLF_Field
	{
		public function enqueue()
		{
			...
			wp_enqueue_script(GLF_BASE_RESOURCE_PREFIX . 'map', GLF_BASE_URL . 'fields/map/assets/map.js', array(), GLF_VER, true);
			...
			wp_enqueue_style(GLF_BASE_RESOURCE_PREFIX . 'map', GLF_BASE_URL . 'fields/map/assets/map.css', array(), GLF_VER);
		...
		function render_content($content_args = '')
		{
			...
			<div class="glf-field-map-inner">
				...
				<?php if( $map_type == 'google_map' ){  ?>
				    <div class="glf-map-canvas glf-map-type" data-maptype="<?php echo $map_type; ?>" data-options="<?php echo esc_attr(wp_json_encode($js_options)); ?>" style="height: 300px; width: 100%"></div>
