...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'golo-framework' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'golo-framework' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'golo-framework' ),
			'200'       => esc_html__( 'Light 200', 'golo-framework' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'golo-framework' ),
			'300'       => esc_html__( 'Book 300', 'golo-framework' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'golo-framework' ),
			'400'       => esc_html__( 'Normal 400', 'golo-framework' ),
			'regular'   => esc_html__( 'Normal 400', 'golo-framework' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'golo-framework' ),
			'500'       => esc_html__( 'Medium 500', 'golo-framework' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'golo-framework' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'golo-framework' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'golo-framework' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'golo-framework' ),
			'700'       => esc_html__( 'Bold 700', 'golo-framework' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'golo-framework' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'golo-framework' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'golo-framework' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'golo-framework' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'golo-framework' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'golo-framework' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'golo-framework' ),
		);
	}
