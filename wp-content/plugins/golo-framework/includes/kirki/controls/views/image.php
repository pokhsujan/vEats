...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'golo-framework' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'golo-framework' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'golo-framework' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'golo-framework' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'golo-framework' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'golo-framework' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'golo-framework' ); ?>',
} );
#>
