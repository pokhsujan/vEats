	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'golo-framework' ),
				'remove'               => esc_html__( 'Remove', 'golo-framework' ),
				'default'              => esc_html__( 'Default', 'golo-framework' ),
				'selectFile'           => esc_html__( 'Select File', 'golo-framework' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'golo-framework' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'golo-framework' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'golo-framework' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'golo-framework' ),
			)
		);
