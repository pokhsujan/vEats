...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'golo-framework' ),
				'change'       => esc_html__( 'Change image', 'golo-framework' ),
				'default'      => esc_html__( 'Default', 'golo-framework' ),
				'remove'       => esc_html__( 'Remove', 'golo-framework' ),
				'placeholder'  => esc_html__( 'No image selected', 'golo-framework' ),
				'frame_title'  => esc_html__( 'Select image', 'golo-framework' ),
				'frame_button' => esc_html__( 'Choose image', 'golo-framework' ),
			)
		);
	}
