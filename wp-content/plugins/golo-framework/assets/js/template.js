...
(function ($) {
    ...
    GLF.element = {
        ...
        ajax_load: function(ajax_call, pagination) {
            var title, height, sortby, price, sort_by, cities, categories, types, place_type, amenities, current_term, type_term, city, location, place_layout;
            var paged = 1;
                    ...
                    function addMarkers() {
                        ...
                        stores.features.forEach(function(marker) {
                            ...
                            **/
                            ...
                            var icon = new PlaceIcon({iconUrl: marker.properties.icon});
                            var rating_html = '';
