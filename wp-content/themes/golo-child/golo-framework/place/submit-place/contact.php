...
<div class="place-fields-wrap">
    ...
    <div class="place-fields place-phone">
        <div class="form-group">
            <input type="text" class="form-control" name="place_phone" placeholder="<?php esc_attr_e('Phone number 1', 'golo-framework'); ?>" />
        </div>
    </div>
</div>
<div class="place-fields-wrap">
...
<!--        <h3>--><?php //esc_html_e('Phone number 2 (optional)', 'golo-framework'); ?><!--</h3>-->
    ...
    <div class="place-fields place-phone">
        <div class="form-group">
            <input type="text" class="form-control" name="place_phone2" placeholder="<?php esc_attr_e('Phone number', 'golo-framework'); ?>" />
        </div>
    </div>
</div>
<?php endif; ?>
